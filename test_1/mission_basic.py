...
def adds_square_mission():
    ...
    cmds.add(
        Command(0, 0, 0, 0, mavutil.mavlink.MAV_CMD_NAV_TAKEOFF, 0, 0, 0, 0,
                0, 0, 41.27615884747215, 1.9883337570627873, 30))
    vehicle.home_location = LocationGlobal(41.27615884747215, 1.9883337570627873, 30)

    """
    1. Upload a mission from a file. 
    """
    # Read mission from file
    missionlist = readmission('/home/ubuntu/RaspiRemote/test_1/mpmission.txt')
    print("\nUpload mission from a file: %s" % '/home/ubuntu/RaspiRemote/test_1/mpmission.txt')
...
while True:
    ...
    if nextwaypoint == 8:  # Dummy waypoint - as soon as we reach waypoint 4 this is true, and we exit.
        print("Exit 'standard' mission when start heading to final dummy waypoint (8)")
        break
    time.sleep(1)
